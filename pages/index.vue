<template>
    <div class="row h-100 pt-5 pe-4">
        <div v-if="posts['news']" class="col-6 px-5 d-flex mb-3 flex-column justify-content-between">
            <HomePagePosts v-for="post in posts['news'].slice(0,5)" :key="post.ID" :post="post" />
        </div>
